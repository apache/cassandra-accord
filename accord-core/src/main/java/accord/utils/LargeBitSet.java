...
public class LargeBitSet implements SimpleBitSet
{
    public static class SerializationSupport
    {
        ...
        public static LargeBitSet construct(long[] bits)
        {
            return new LargeBitSet(bits);
        }
    }
    ...
    public LargeBitSet(int size)
    {
        bits = new long[(size + 63)/64];
        length = bits.length;
    }

    public LargeBitSet(int size, boolean set)
    {
        this(size);
        if (set)
        {
    ...
    public LargeBitSet(LargeBitSet copy)
    {
        this(copy, false);
    }

    public LargeBitSet(LargeBitSet copy, boolean share)
    {
    ...
    public LargeBitSet(int size, ArrayBuffers.LongBuffers buffers)
    {
        length = (size + 63) / 64;
    ...
    private int nextSetBitInternal(int i, int exclIndexBound, int ifNotFound)
    {
        ...
        {
            if (bits != 0)
                return index * 64 + numberOfTrailingZeros(bits);
    ...
    static long bit(int i)
    {
        return 1L << i;
    }

    static long bitsEqualOrGreater(int i)
    {
        return -1L << i;
    }
    ...
    {
        return other instanceof LargeBitSet && this.equals((LargeBitSet) other);
    }

    public boolean equals(LargeBitSet other)
    {
