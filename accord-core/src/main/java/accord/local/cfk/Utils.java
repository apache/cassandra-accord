...
class Utils
{
    ...
    {
        // TODO (desired): consider; we perhaps expect manages(id) to normally be true,
        //  so we could optimistically assume we will keep all ids at the cost of some wasted allocations
        int count = 0;
        for (TxnId id : ids)
