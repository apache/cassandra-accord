...
public abstract class Persist implements Callback<ApplyReply>
{
    ...
    public void start(Apply.Factory factory, Apply.Kind kind, Topologies participates, Topologies executes, Writes writes, Result result)
    {
        ...
        node.send(participates.nodes(), to -> factory.create(kind, to, participates, executes, txnId, route, txn, executeAt, stableDeps, writes, result), this);
    }
}
