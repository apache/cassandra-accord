...
public class ListFetchCoordinator extends AbstractFetchCoordinator
{
    ...
    {
        return new PartialTxn.InMemory(Txn.Kind.Read, ranges, new ListRead(Function.identity(), false, ranges, ranges), new ListQuery(Node.Id.NONE, Long.MIN_VALUE, false), null, null);
    }
