...
{
    public enum Fault { HeartBeat, Invalidated, Lost, Timeout }
    ...
    public static ListResult timeout(Id client, long requestId, TxnId txnId)
    {
        return new ListResult(client, requestId, txnId, Fault.Timeout);
    }
