    ...
    methods: {
            ...
            const sampleData = [
                {
                    "from": "127.0.0.1",
                    "to": "127.0.0.2", 
                    "message_kind": "PREPARE_REQ",
                    "tags": ["prepare", "phase1"],
                    "short_description": "Prepare",
                    "long_description": "Prepare request for transaction TX1 with ballot 1",
                    "sent_at": 1000,
                    "received_at": 1050
                },
                {
                    "from": "127.0.0.2",
                    "to": "127.0.0.1",
                    "message_kind": "PREPARE_RSP",
                    "tags": ["prepare", "phase1"],
                    "short_description": "Prepare",
                    "long_description": "Prepare response for transaction TX1 with ballot 1",
                    "sent_at": 1050,
                    "received_at": 1060
                },
                {
                    "from": "127.0.0.2",
                    "to": "127.0.0.1",
                    "message_kind": "PREPARE_OK",
                    "tags": ["prepare", "phase1"],
                    "short_description": "Prepare OK",
                    "long_description": "Prepare response for transaction TX1 - accepted",
                    "sent_at": 1100,
                    "received_at": 1150
                },
                {
                ...
                },
                {
                    "from": "127.0.0.1",
                    "to": "127.0.0.2",
                    "message_kind": "ACCEPT_REQ",
                    "tags": ["accept", "phase2"],
                    "short_description": "Accept",
                    "long_description": "Accept request for transaction TX1 with commands and dependencies",
                    "sent_at": 1400,
                    "received_at": 1450
                },
                {
                ...
                },
                {
                    "from": "127.0.0.2",
                    "to": "127.0.0.1",
                    "message_kind": "ACCEPT_OK",
                    "tags": ["accept", "phase2"],
                    "short_description": "Accept OK",
                    "long_description": "Accept response for transaction TX1 - committed",
                    "sent_at": 1600,
                    "received_at": 1650
                },
                {
                    ...
                    "tags": ["timeout", "internal"],
                    "short_description": "Timeout",
                    "long_description": "Internal timeout event for transaction TX1 - triggering cleanup",
                    "sent_at": 1700,
                    "received_at": 1705
                },
                {
        ...
        processMessages() {
            ...
            sortedTimestamps.forEach((timestamp, index) => {
                this.timeMap.set(timestamp, index);
            });
            
            // Process filtered messages with normalized timestamps
            this.processedMessages = filteredMessages.map(msg => ({
                ...msg,
                normalizedSentAt: this.timeMap.get(msg.sent_at),
                normalizedReceivedAt: this.timeMap.get(msg.received_at)
            }))
        ...
        calculateDimensions() {
            ...
            const maxTime = this.timeMap.size > 0 ? Math.max(...Array.from(this.timeMap.values())) : 0;
